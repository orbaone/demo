      ...
      c = t
        ...
        : (function(e) {
            ...
            return {
              ...
              idle: function() {
                e.innerHTML = o("Verify Me");
              },
              success: function() {
                e.innerHTML = o("Complete");
              },
              error: function() {
                e.innerHTML = o("Could Not Start Verification");
              }
            };
    ...
    return (
      ...
      (function(e, n, t, o, r) {
        ...
        function l() {
          r((a = "idle")),
            e &&
              (window.removeEventListener(d, u), document.body.removeChild(e));
        }
        function u(e) {
          if ((console.log(e), e.origin != i)) {
            var r = JSON.parse(e.data);
            r.status === s ? (n(r), l()) : r.status === c ? (t(r), l()) : o(r);
          }
        }
        return (
          (e.onload = function() {
