...
function r(n, e, t, i, o) {
  ...
  return (
    ...
    (function(n, e, t, i, o) {
      ...
      function s(n) {
        if (
          (console.log(n), "https://staging-verify.orbaone.com/" != n.origin)
        ) {
          var o = JSON.parse(n.data);
          "orba_one_success" === o.status
            ? (e(o), a())
            : "orba_one_cancel" === o.status
            ? (t(o), a())
            : i(o);
        }
      }
...
exports.renderButton = function(e) {
  var t = e.target,
    i = e.disableStyle,
    a = e.onChange;
  if (
