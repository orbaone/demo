<template>
  <div class="shadow-md rounded p-4">
    <div class="flex justify-between">
      <p class="text-xl text-gray-800">Latest travel news</p>
      <p class="text-orange-500 font-bold">View all</p>
    </div>
    <div class="flex flex-col">
      ...
      <div class="flex w-full my-3">
        ...
        <div class="flex-grow p-2">
          <p class="text-gray-700 font-bold text-md">
            Mountain climb of a life-time <br />
            Fanjingshan, China
          </p>
          <p class="text-sm text-gray-500 font-mono">@faketravel</p>
        </div>
