...
function r(n, e, t, i, o, r) {
  ...
  return (
    ...
    (function(n, e, t, i, o, r) {
      var a = "idle";
      function s() {
        r((a = "idle")), n && (window.removeEventListener("message", l), c());
      }
      function c() {
      ...
      function d() {
        ...
        var e = window.innerHeight.toString() + "px";
      ...
      function l(n) {
        "orba_one_success" === n.data
          ? (t({ applicantId: e, status: "success" }), s())
          : "orba_one_cancel" === n.data
          ? (i({ applicantId: e, status: "cancelled" }), s())
          : o({ applicantId: e, status: "error" });
      }
      return (
        (n.onload = function() {
          r((a = "success"));
