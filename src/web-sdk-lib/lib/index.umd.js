!(function(e, n) {
  ...
  var a = "orba_one_success",
    s = "orba_one_cancel",
    c = "message";
  function d(e, n, t, i, o, r) {
    var d = document.createElement("iframe");
    return (
      (d.allow = "geolocation; microphone; camera; fullscreen;"),
      (d.src = e),
      d.setAttribute(
        "style",
        "\n position: absolute;\n top: 0;\n left: 0;\n right: 0;\n bottom:0;\n width: 100vw;\n height: 100vh;\n border: none;\n"
      ),
      (d.dataset.testid = "orba-iframe"),
      (function(e, n, t, i, o, r) {
        var d = "idle";
        function l() {
          r((d = "idle")), e && (window.removeEventListener(c, p), u());
        }
        function u() {
        ...
        function p(e) {
          e.data === a
            ? (t({ applicantId: n, status: "success" }), l())
            : e.data === s
            ? (i({ applicantId: n, status: "cancelled" }), l())
        ...
        return (
          ...
          }),
          {
            ...
            connect: function() {
              ...
              "idle" === d &&
                (r((d = "loading")), f(), window.addEventListener(c, p));
            },
            disconnect: l,
            status: function() {
              return d;
